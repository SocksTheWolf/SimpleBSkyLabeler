/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/wrangler.d.ts` (hash: 25b70dee49c656adc7c28618db417358)
// Runtime types generated with workerd@1.20260625.1 2024-12-18 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	BSKY_LABEL_LIMITER: RateLimit;
	ASSETS: Fetcher;
	COUNT_CACHE_HOUR: "4";
	RATELIMIT: "true";
	SITE_TITLE: "Simple BSky Labeler";
	SITE_DESCRIPTION: "Allow people to obtain a bsky label you provide";
	SITE_SHORTNAME: "SBL";
	LABEL_SRC: "";
	LABEL_VAL: "";
}
